 ...
 */
final class Version20240113164830 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE shop_cart (id UUID NOT NULL, shop_item_id INT NOT NULL, session_id VARCHAR(255) NOT NULL, count INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_CA516ECC115C1274 ON shop_cart (shop_item_id)');
        $this->addSql('COMMENT ON COLUMN shop_cart.id IS \'(DC2Type:shop_cart_id)\'');
